def map_typeII_transcription_terminators(seq):
    import pandas as pd
    motifs = pd.read_csv('src/Termination sites.csv')
...
def plotTypeIITranscriptionTerminators(seq):
    ...
    import pandas as pd
    from src.terminators import map_typeII_transcription_terminators
    from src.utils import find_orf, context_score
